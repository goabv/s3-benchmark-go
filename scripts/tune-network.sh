...
# restores precisely what was there (not guessed defaults). Idempotent.
#
...
#                                idle. Part fetching is bursty, and the default
#                                re-ramps every connection back to slow-start.
#   tcp_congestion_control=bbr   Ramp to available bandwidth faster than CUBIC.
